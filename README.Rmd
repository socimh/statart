...
[statart](socimh.github.io/statart/) is a collection of functions providing Stata-inspired functionality alongside tidyverse-style operations. I believe statart + tidyverse will be a good combination for both Stata and R users, fresh or experienced. Learn more in vignette("statart").
